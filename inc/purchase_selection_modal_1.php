		...
		<div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
			<div class="left-data-col d-flex flex-wrap">
				<div class="total-data">
					<p class="p-label f-14">売上合計</p>
					<p class="p-price f-15">¥421,972</p>
					<p class="p-percentage clr-blue f-12">+3.2%</p>
				</div>
				<div class="total-data">
					<p class="p-label f-14">注⽂数</p>
					<p class="p-price f-15">92件</p>
					<p class="p-percentage clr-blue f-12">+3.2%</p>
				</div>
				<div class="total-data">
					<p class="p-label f-14">平均注⽂単価</p>
					<p class="p-price f-15">¥1,219</p>
					<p class="p-percentage clr-red f-12">-15.2%</p>
				</div>
			</div>
			<!--left-col-->
			...
			<div class="card mb-3">
				<div class="card-body">
					<div class="table-responsive-lg">
						<table class="table purchase-selected-modal-1">
							<thead>
								<tr>
									...
									<th class="column-8">利益</th>
									<th class="column-9">利益率</th>
								</tr>
							</thead>
							<tbody>
								<tr>
							...
							<tbody>
								<tr>
									...
									<td class="text-center" rowspan="3">
										<p><img src="dist/img/icons/icon-sm-amazon.png" alt="" /></p>
										<p>THEフィギュアシ…</p>
									</td>
									<td class="text-center" rowspan="3">
										<p>amazonFBA</p>
