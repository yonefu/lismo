<div class="inner-page-wrap">
	<div class="order-hold-modal-page w-100">
			...
			<div class="card">
				<div class="card-body">
					<div class="table-responsive-lg">
						<table class="table order-return-warehouse-table">
							<thead>
								<tr class="blank-tr">
							...
							<tbody>
								<tr>
									...
									<td class="d-flex align-items-center">
										...
										<p>Final Fantasy Plush - Chocobo 30th
									...
									<td class="text-center">
										<label>複製個数</label>
										<input type="text" class="form-control text-right" placeholder="1">
									</td>
									<td class="text-center">
										<label>状態</label>
								...
								<tr>
									<td class="text-center">
										<img src="dist/img/icons/icon-sm-amazon.png" alt="Amazon" />
										<p>ショップ名ABC</p>
										<p><small class="text-muted">114-181062</small></p>
										<p><small class="text-muted">8-1813868</small></p>
									</td>
		...
		<div class="col-md-6 col-lg-3 mb-4 ml-auto">
			<form>
	  			<div class="form-group">
					<label class="f-15">返送先の倉庫</label>
					<select class="custom-select">
						<option selected>横浜本社倉庫</option>
						<option value="1">横浜本社倉庫</option>
						<option value="2">横浜本社倉庫</option>
					</select>
				</div>
	  			<div class="form-group">
					<label class="f-15">返送の理由(任意)</label>
					<textarea class="form-control" rows="4" placeholder="先⽅と連絡がつかないため。14⽇までに連 絡がないので返送とした。"></textarea>
				</div>
			</form>
		</div>
		...
		<div class="d-flex justify-content-end">
			...
			<a href="#" class="btn btn-dark"><span>返送する</span></a>
		</div>
