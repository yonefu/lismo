		...
		<div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
			<div class="left-data-col d-flex flex-wrap">
				<div class="total-data">
					<p class="p-label f-14">在庫数合計</p>
					<p class="p-price f-15">16,572個</p>
					<p class="p-percentage clr-blue f-12">+3.2%</p>
				</div>
				<div class="total-data">
					<p class="p-label f-14">在庫総額</p>
					<p class="p-price f-15">¥9,421,972</p>
					<p class="p-percentage clr-blue f-12">-15.2%</p>
				</div>
			</div>
			<!--left-col-->
							...
							<tbody>
								<tr>
									...
									<td class="d-flex align-items-center">
										...
										<p>そらのおとしもどろいど  ニンフ (ノンス ケール ABS素材…
