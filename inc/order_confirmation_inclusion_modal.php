<div class="inner-page-wrap">
	<div class="order-confirmation-inclusion-page w-100">
		<div class="d-flex justify-content-between align-items-center mb-3">
			<h3 class="page-title mb-1 f-18">
				<span>選択した出荷を同梱出荷にしますか?</span>
			</h3>
		</div>
		<p class="f-12">
			<span>同軍後の出荷ID : </span><span>FO00453700</span>
		</p>
		<!--div-->
						...
						<table class="table order-confirmation-inclusion-table">
								...
								<tr>
									<td class="text-center">
										<div class="position-relative custom-control custom-checkbox">
											<input type="checkbox" class="form-check-input custom-control-input ml-0 selectedId" id="selectedId10">
							...
							<tbody>
								<tr>
									<td class="text-center">
										<div class="position-relative custom-control custom-checkbox">
											<input type="checkbox" class="form-check-input custom-control-input ml-0 selectedId" id="selectedId11">
									...
									<td class="text-center">
										<img src="dist/img/icons/icon-secure.png" alt="" />
										<p>在庫確保済み</p>
									</td>
								</tr>
							</tbody>
		...
		<div class="d-flex justify-content-end">
			...
			<a href="#" class="btn btn-dark"><span>同梱にする</span></a>
		</div>

	</div>
	<!--order-confirmation-inclusion-page w-100-->
</div>
<!--inner-page-wrap-->
