...
<html lang="jp">
	...
	<body>
		...
		<section class="commericial_transaction_law static-page">
			<div class="container">
				<h3 class="f-30 font-weight-bold page-title">特定商取引法に基づく表記</h3>

				<div class="box-wrap">
					<strong class="f-15">事業者名</strong>
					<p class="mb-0">株式会社illustrious</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">運営責任者</strong>
					<p class="mb-0">永⽊  貴幸</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">所在地</strong>
					<p class="mb-0">東京都渋⾕区渋⾕1-24-4 渋⾕こうゆうビル503</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">連絡先</strong>
					<p class="mb-0">TEL: 03-6427-1867<br/>
						(お電話でのお問い合わせは対応不可です。折返しTELもできません。お問い合わせは問い合わせフォー ムよりお願いします。)<br/>
					定休⽇：  ⼟⽇祝祭⽇/GW/夏季/年末年始 | 営業時間： 9：00〜18：00</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">URL</strong>
					<p class="mb-0"><a href="https://lismoa.com">https://lismoa.com</a></p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">販売価格</strong>
					<p class="mb-0">選択されたプランに応じて利⽤料⾦が発⽣します。</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">商品代⾦以外の付帯費⽤</strong>
					<p class="mb-0">表⽰料⾦は消費税込みです</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">代⾦の⽀払時期</strong>
					<p class="mb-0">申込み完了時、以後⽉毎⾃動⽀払い</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">代⾦の⽀払⽅法</strong>
					<p class="mb-0">クレジットカード</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">商品等の引き渡し時期</strong>
					<p class="mb-0">決済完了後、すぐに利⽤いただけます。</p>
				</div>
				<div class="box-wrap">
					<strong class="f-15">返品の可否と条件</strong>
					<p class="mb-0">商品の性質上、原則として返品・返⾦はお受け出来ませんので予めご了承下さい。  データが壊れている 等、商品⽋陥がある場合は個別で対応させて頂きます。</p>
				</div>
			</div>
		</section>
		<!--static-page-->
